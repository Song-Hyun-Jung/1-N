...
<html style="font-size: 16px;">
  <head>
    ...
    <title>login</title>
    <link rel="stylesheet" href="/static/style/login/nicepage.css" media="screen">
	<link rel="stylesheet" href="/static/style/login/mainpage.css" media="screen">
  ...
  <body class="u-body">
	...
	userCreate = function(targetUri) {
		...
		form2.method="GET";		// register form ìì²­
		form2.submit();
	}
	login = function() {
		if (form.email.value == "") {
		alert("사용자 email를 입력하십시오.");
		form.email.focus();
		return false;
	}
  ...
  <header class="u-clearfix u-header u-header" id="sec-5a17"><div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-text u-text-1">
          <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-dark-1 u-btn-1" href="/shop/register.do">
          <span class="u-icon u-icon-1">
          <svg class="u-svg-content" viewBox="0 0 128 128" style="width: 1em; height: 1em;">
              ...
              <div class="u-align-center-sm u-align-center-xs u-container-style u-layout-cell u-shape-rectangle u-size-29 u-white u-layout-cell-2">
                <div class="u-container-layout u-valign-middle u-container-layout-2">
                  ...
                  <div class="u-expanded-width-xs u-form u-login-control u-form-1">
                    <form action="/shop/login" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-15 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 0px;">
                  ...
                  onClick="location.href='/shop/register.do'" >
                  </form>
                  <input type = "button" value = "메인페이지로 돌아가기" class="u-border-1 u-border-active-palette-1-base u-border-hover-palette-1-base u-btn u-button-style u-login-control u-login-forgot-password u-none u-text-palette-1-base u-btn-2"
